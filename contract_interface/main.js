import {
  ...
  showLogining,
  showRegistration,
} from "./src/hideShowAuth.js"; // импорт функций для отображения/скрытия окна авторизации, входа в аккаунт(отдельно) и регистрации(отдельно)
import * as vars from "./src/variables.js"; // импорт констант с querySelector
import { createAdminPanel } from "./src/createAdminPanel.js";

console.log("hi");
let contractAddress = "0x0A00DD30D4f86F87269DBa9d88D0190Ac264F6CA";
...
function enterAccount(user, adr) {
...
vars.authRegBtn.addEventListener("click", () => {
...
vars.btnShowAllTranasctions.addEventListener("click", async () => {
  let allTransactions = await contractInstance.methods
